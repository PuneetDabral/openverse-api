...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = \
        os.getenv('LOGOS_BUCKET', 'openverse-api-logos-prod')
...
WATERMARK_ENABLED = \
    os.getenv('WATERMARK_ENABLED', 'False').lower() in TRUE_STRINGS
...
USE_RANK_FEATURES = \
    os.getenv('USE_RANK_FEATURES', 'True').lower() in TRUE_STRINGS
